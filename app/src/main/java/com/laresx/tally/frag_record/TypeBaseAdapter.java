...
public class TypeBaseAdapter extends BaseAdapter {
    ...
    //reuse is not applicable for this adapter as all items are shown on the page with no remaining counterview
    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //check if current is seleted, if so showing the colorful image
